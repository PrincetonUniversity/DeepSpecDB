        ...
        (Ssequence
          (Scall (Some _t'3)
            ...
            ((Ebinop Omul (Econst_int (Int.repr 8) tint)
               (Esizeof (tptr (Tstruct _lock_t noattr)) tuint) tuint) :: nil))
          (Sset _locks
                    ...
                    (Ssequence
                      ...
                      (Ssequence
                        (Sassign
                          (Ederef
                            (Ebinop Oadd
                              (Etempvar _locks (tptr (tptr (Tstruct _lock_t noattr))))
                              (Etempvar _i tint)
                              (tptr (tptr (Tstruct _lock_t noattr))))
                            (tptr (Tstruct _lock_t noattr)))
                          (Etempvar _ll (tptr (Tstruct _lock_t noattr))))
...
Definition f_read := {|
  ...
  fn_temps := ((_l, (tptr (Tstruct _lock_t noattr))) :: (_ver, tint) ::
               ...
               (_v, tint) ::
               (_t'3, (tptr (tptr (Tstruct _lock_t noattr)))) ::
                      ...
                      (Ssequence
                        (Ssequence
                          ...
                          (Sset _dlock
                            (Ederef
                              (Ebinop Oadd
                                (Etempvar _t'3 (tptr (tptr (Tstruct _lock_t noattr))))
                                (Etempvar _i tint)
                                (tptr (tptr (Tstruct _lock_t noattr))))
                              (tptr (Tstruct _lock_t noattr)))))
                        (Ssequence
...
Definition f_node_free := {|
  ...
  fn_temps := ((_l, (tptr (Tstruct _lock_t noattr))) :: (_i, tint) ::
               (_ll, (tptr (Tstruct _lock_t noattr))) ::
               (_t'3, (tptr (tptr (Tstruct _lock_t noattr)))) ::
               (_t'2, (tptr (tptr (Tstruct _lock_t noattr)))) ::
               (_t'1, (tptr tint)) :: nil);
  fn_body :=
(Ssequence
  (Sset _l
            ...
            (Ssequence
              ...
              (Scall None
                (Evar _free (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                              cc_default))
                ((Etempvar _t'2 (tptr (tptr (Tstruct _lock_t noattr)))) ::
                 nil)))
            (Ssequence
              (Ssequence
                (Sset _t'1
        ...
        (Ssequence
          ...
          (Sloop
            (Ssequence
              ...
              (Ssequence
                (Ssequence
                  (Sset _t'10 (Evar _first (tptr tint)))
                  (Sassign
                    (Ederef
                    ...
                    (Etempvar _i tint)))
                (Ssequence
                  (Sset _t'9 (Evar _second (tptr tint)))
                  (Sassign
                    (Ederef
                            ...
                            (Ssequence
                              ...
                              (Ssequence
                                (Sset _t'6
                                  (Ederef
                                    (Ebinop Oadd
                                      (Etempvar _result (tptr tint))
                                      (Etempvar _i__1 tint) (tptr tint))
                                    tint))
                                (Scall None
...
(Composite _lock_t Struct
 ...
 Composite _node Struct
   (Member_plain _vlock (tptr (Tstruct _lock_t noattr)) ::
    ...
    Member_plain _dlocks (tptr (tptr (Tstruct _lock_t noattr))) ::
...
(_main :: _thread_func :: _node_free :: _write :: _read :: _node_new ::
 ...
 _makelock :: _exit :: _free :: _malloc :: _printf :: ___builtin_debug ::
