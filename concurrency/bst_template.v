...
Definition _insert2 : ident := $"insert2".
...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 82) :: Init_int8 (Int.repr 105) ::
...
Definition f_insert := {|
  ...
  fn_temps := ((_tgt, (tptr (Tstruct _tree_t noattr))) ::
               ...
               (_t'3, (tptr tvoid)) :: (_t'2, (tptr tvoid)) ::
               (_t'1, (tptr tvoid)) :: (_t'9, tint) :: (_t'8, tint) ::
               (_t'7, (tptr tvoid)) :: (_t'6, tint) :: nil);
  fn_body :=
(Ssequence
  (Sset _tgt
                                ...
                                (Ssequence
                                  (Scall (Some _t'4)
                                    (Evar _surely_malloc (Tfunction
                                                           ...
                                                           (tptr tvoid)
                                                           cc_default))
                                    ((Esizeof (tarray (tptr tvoid) 2) tulong) ::
                                     nil))
                                  (Sset _l2
                                        ...
                                        (Ssequence
                                          (Scall (Some _t'5)
                                            (Evar _surely_malloc (Tfunction
                                                                   ...
                                                                   (tptr tvoid)
                                                                   cc_default))
                                            ((Esizeof (Tstruct _tree noattr) tulong) ::
                                             nil))
                                          (Sset _p
                                            (Ecast
                    ...
                    (Ssequence
                      (Ssequence
                        ...
                        (Scall None
                          ...
                          ((Evar ___stringlit_3 (tarray tschar 23)) ::
                           (Etempvar _x tint) :: (Etempvar _t'9 tint) :: nil)))
                      (Ssequence
                        ...
                        (Ssequence
                          ...
                          (Scall None
                            ...
                            ((Evar ___stringlit_2 (tarray tschar 24)) ::
                             (Etempvar _x tint) :: (Etempvar _t'8 tint) ::
                             nil)))
                        (Ssequence
...
Definition f_traverse := {|
  ...
  fn_temps := ((_flag, tint) :: (_b, tint) :: (_t'1, tint) ::
               ...
               (_t'7, (tptr (tarray (tptr tvoid) 2))) ::
               (_t'6, (tptr (Tstruct _tree_t noattr))) ::
               (_t'5, (tptr (tarray (tptr tvoid) 2))) ::
               (_t'4, (tptr (Tstruct _tree_t noattr))) ::
                        ...
                        (Ssequence
                          ...
                          (Scall None
                            (Evar _acquire (Tfunction
                                             (Tcons (tptr tvoid) Tnil) tvoid
                                             cc_default))
                            ((Etempvar _t'7 (tptr (tarray (tptr tvoid) 2))) ::
                             nil))))
                      (Ssequence
                        (Sset _t'4
                          (Efield
                        ...
                        (Ssequence
                          ...
                          (Scall None
                            (Evar _release2 (Tfunction
                                              (Tcons (tptr tvoid) Tnil) tvoid
                                              cc_default))
                            ((Etempvar _t'5 (tptr (tarray (tptr tvoid) 2))) ::
                             nil))))))))))))
      Sskip)
        ...
        (Ssequence
          ...
          (Ssequence
            (Scall None
              (Evar _makelock (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                                cc_default))
              ((Etempvar _l1 (tptr (tarray (tptr tvoid) 2))) :: nil))
            (Ssequence
              (Sassign
                (Efield
                  (Ederef (Etempvar _p1 (tptr (Tstruct _tree_t noattr)))
                  ...
                  (Ssequence
                    (Scall None
                      (Evar _makelock (Tfunction (Tcons (tptr tvoid) Tnil)
                                        tvoid cc_default))
                      ((Etempvar _l2 (tptr (tarray (tptr tvoid) 2))) :: nil))
                    (Ssequence
                      (Sassign
                        (Efield
                          (Ederef
        ...
        (Ssequence
          ...
          (Scall None
            (Evar _acquire (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                             cc_default))
            ((Etempvar _t'8 (tptr (tarray (tptr tvoid) 2))) :: nil))))
      (Ssequence
        (Ssequence
          (Scall (Some _t'2)
          ...
          (Ssequence
            ...
            (Ssequence
              ...
              (Scall None
                (Evar _release2 (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                                  cc_default))
                ((Etempvar _t'4 (tptr (tarray (tptr tvoid) 2))) :: nil))))
          (Scall None
            (Evar _free (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                          cc_default))
...
Definition f_traverseInorder := {|
  ...
  fn_temps := ((_p, (tptr (Tstruct _tree noattr))) ::
               (_tgt, (tptr (Tstruct _tree_t noattr))) :: nil);
  fn_body :=
(Ssequence
  (Sset _tgt
    (Ederef (Etempvar _t (tptr (tptr (Tstruct _tree_t noattr))))
  ...
  (Ssequence
    (Scall None
      ...
      ((Ecast (Etempvar _l (tptr (tarray (tptr tvoid) 2))) (tptr tvoid)) ::
       nil))
    (Sreturn (Some (Ecast (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid))
                     (tptr tvoid))))))
|}.
...
Definition f_main := {|
  ...
  fn_temps := ((_t_lock, (tptr (tarray (tptr tvoid) 2))) ::
               ...
               (_t'3, (tptr (tptr (Tstruct _tree_t noattr)))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
        ...
        (Ssequence
          ...
          (Scall None
            ...
            ((Etempvar _t'8 (tptr (tptr (Tstruct _tree_t noattr)))) ::
             ...
             (Evar ___stringlit_5 (tarray tschar 6)) :: nil)))
        (Ssequence
          (Ssequence
            ...
            (Scall None
              ...
              ((Etempvar _t'7 (tptr (tptr (Tstruct _tree_t noattr)))) ::
               ...
               (Evar ___stringlit_6 (tarray tschar 4)) :: nil)))
          (Ssequence
            (Ssequence
              ...
              (Scall None
                ...
                ((Etempvar _t'6 (tptr (tptr (Tstruct _tree_t noattr)))) ::
                 ...
                 (Evar ___stringlit_7 (tarray tschar 5)) :: nil)))
            (Ssequence
              (Scall None
                (Evar _makelock (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                                  cc_default))
                      ...
                      (Ssequence
                        ...
                        (Scall None
                          (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil)
                                          tint
                                          {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                          ((Evar ___stringlit_8 (tarray tschar 4)) ::
                      ...
                      (Ssequence
                        (Scall None
                          (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil)
                                          tint
                                          {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                          ((Evar ___stringlit_9 (tarray tschar 10)) :: nil))
                        (Ssequence
                          (Ssequence
                            (Sset _t'4
                              (Evar _tb (tptr (tptr (Tstruct _tree_t noattr)))))
...
((___compcert_va_int32,
 ...
 (___compcert_i64_umulh,
   Gfun(External (EF_runtime "__compcert_i64_umulh"
                   (mksignature (AST.Tlong :: AST.Tlong :: nil) AST.Tlong
                     cc_default)) (Tcons tulong (Tcons tulong Tnil)) tulong
     cc_default)) :: (___stringlit_7, Gvar v___stringlit_7) ::
 ...
 (_insert2, Gfun(Internal f_insert2)) ::
...
(_main :: _thread_func :: _lookup :: _traverseInorder :: _Inorder ::
 _insert2 :: _insertOp :: _traverse :: _findnext :: _insert ::
 _treebox_free :: _tree_free :: _treebox_new :: _surely_malloc :: _tb ::
 _thread_lock :: _exit :: _free :: _malloc :: _spawn :: _release2 ::
 _freelock2 :: _acquire :: _makelock :: _printf :: ___builtin_debug ::
