...
Module Info.
  ...
  Definition source_file := "bst_conc_nblocking4.c".
...
Definition _clear__1 : ident := $"clear__1".
...
Definition _new_op : ident := $"new_op".
Definition _new_op__1 : ident := $"new_op__1".
Definition _new_op__2 : ident := $"new_op__2".
Definition _new_ref : ident := $"new_ref".
Definition _next : ident := $"next".
Definition _node : ident := $"node".
Definition _old : ident := $"old".
Definition _old__1 : ident := $"old__1".
Definition _old_op : ident := $"old_op".
Definition _op : ident := $"op".
Definition _operation : ident := $"operation".
...
Definition _root_op : ident := $"root_op".
...
Definition f_GET_FLAG := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_ptr, (tptr (Tstruct _operation noattr))) :: nil);
  fn_vars := nil;
...
(Ssequence
  (Sset _t'1
    (Efield
      (Ederef (Etempvar _ptr (tptr (Tstruct _operation noattr)))
        (Tstruct _operation noattr)) _type tint))
...
Definition f_helpChildCAS := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_op, (tptr (Tstruct _operation noattr))) ::
                (_dest, (tptr (Tstruct _tree noattr))) ::
                (_thread_num, tint) :: nil);
  fn_vars := ((_tp, (tptr tvoid)) :: (_old, (tptr tvoid)) :: nil);
  fn_temps := ((_cas_op, (tptr (Tstruct _child_cas_operation noattr))) ::
               (_address, (tptr (Tstruct _atom_ptr noattr))) ::
               (_new_op, (tptr (Tstruct _operation noattr))) ::
               (_clear, tint) :: (_t'4, tint) :: (_t'3, (tptr tvoid)) ::
...
(Ssequence
  (Ssequence
    (Sset _t'11
      (Efield
        (Ederef (Etempvar _op (tptr (Tstruct _operation noattr)))
          (Tstruct _operation noattr)) _op (tptr tvoid)))
    (Sset _cas_op
          ...
          (Ssequence
            (Scall (Some _t'3)
              (Evar _surely_malloc (Tfunction (Tcons tuint Tnil) (tptr tvoid)
                                     cc_default))
              ((Esizeof (Tstruct _operation noattr) tuint) :: nil))
            (Sset _new_op
              (Ecast (Etempvar _t'3 (tptr tvoid))
                (tptr (Tstruct _operation noattr)))))
          (Ssequence
            (Sassign
              (Efield
                (Ederef (Etempvar _new_op (tptr (Tstruct _operation noattr)))
                  (Tstruct _operation noattr)) _op (tptr tvoid))
            ...
            (Ssequence
              (Sassign
                (Efield
                  (Ederef
                    (Etempvar _new_op (tptr (Tstruct _operation noattr)))
                    (Tstruct _operation noattr)) _type tint)
                (Econst_int (Int.repr 0) tint))
              (Ssequence
                (Sassign (Evar _old (tptr tvoid))
                  (Etempvar _op (tptr (Tstruct _operation noattr))))
                (Ssequence
                  (Ssequence
                    (Ssequence
                      (Sset _t'5
                        (Efield
                          (Ederef
                            (Etempvar _dest (tptr (Tstruct _tree noattr)))
                      ...
                      (Scall (Some _t'4)
                        ...
                        ((Etempvar _t'5 (tptr (Tstruct _atom_ptr noattr))) ::
                         (Eaddrof (Evar _old (tptr tvoid))
                           (tptr (tptr tvoid))) ::
                         (Etempvar _new_op (tptr (Tstruct _operation noattr))) ::
                         nil)))
                    (Sset _clear (Etempvar _t'4 tint)))
                  (Sifthenelse (Eunop Onotbool (Etempvar _clear tint) tint)
                    (Scall None
...
Definition f_helpRelocate := {|
  ...
  fn_params := ((_op, (tptr (Tstruct _operation noattr))) ::
                ...
                (_curr, (tptr (Tstruct _tree noattr))) ::
                (_thread_num, tint) :: nil);
  fn_vars := ((_i, tint) :: (_i__1, tint) :: (_old, (tptr tvoid)) ::
              (_old__1, (tptr tvoid)) :: nil);
  fn_temps := ((_reloc_op, (tptr (Tstruct _relocate_operation noattr))) ::
               (_seen_state, tint) ::
               (_real_dest, (tptr (Tstruct _tree noattr))) ::
               (_old_op, (tptr (Tstruct _operation noattr))) ::
               (_success, tint) ::
               (_new_op, (tptr (Tstruct _operation noattr))) ::
               (_clear, tint) :: (_result, tint) ::
               (_new_op__1, (tptr (Tstruct _operation noattr))) ::
               (_clear__1, tint) ::
               (_new_op__2, (tptr (Tstruct _operation noattr))) ::
               (_t'12, (tptr tvoid)) :: (_t'11, tint) :: (_t'10, tint) ::
               (_t'9, (tptr tvoid)) :: (_t'8, tint) ::
               (_t'7, (tptr tvoid)) :: (_t'6, tint) :: (_t'5, tint) ::
               (_t'4, tint) :: (_t'3, (tptr tvoid)) ::
               (_t'2, (tptr tvoid)) :: (_t'1, tint) ::
               (_t'25, (tptr tvoid)) ::
               (_t'24, (tptr (Tstruct _atom_int noattr))) ::
               ...
               (_t'19, (tptr (Tstruct _atom_int noattr))) ::
               (_t'18, (tptr (Tstruct _atom_int noattr))) :: (_t'17, tint) ::
               (_t'16, (tptr tvoid)) ::
               (_t'15, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'14, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'13, (tptr (Tstruct _atom_ptr noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _t'25
      (Efield
        (Ederef (Etempvar _op (tptr (Tstruct _operation noattr)))
          (Tstruct _operation noattr)) _op (tptr tvoid)))
    (Sset _reloc_op
      (Ecast (Etempvar _t'25 (tptr tvoid))
      ...
      (Ssequence
        ...
        (Scall (Some _t'1)
          (Evar _atom_load (Tfunction
                             ...
                             tint cc_default))
          ((Etempvar _t'24 (tptr (Tstruct _atom_int noattr))) :: nil)))
                ...
                (Scall (Some _t'3)
                  (Evar _atomic_load_ptr (Tfunction
                                           (Tcons
                                             (tptr (Tstruct _atom_ptr noattr))
                                             Tnil) (tptr tvoid) cc_default))
                  ((Etempvar _t'22 (tptr (Tstruct _atom_ptr noattr))) :: nil)))
              ...
              (Ssequence
                (Sifthenelse (Etempvar _success tint)
                  ...
                  (Sset _t'6
                    (Ecast
                      (Ebinop Oeq
                        (Etempvar _old_op (tptr (Tstruct _operation noattr)))
                        (Etempvar _op (tptr (Tstruct _operation noattr)))
                        tint) tbool)))
                        ...
                        (Ssequence
                          ...
                          (Scall (Some _t'5)
                            ...
                            ((Etempvar _t'19 (tptr (Tstruct _atom_int noattr))) ::
                             nil)))
                        (Sset _seen_state (Etempvar _t'5 tint)))
                      (Ssequence
                        (Sset _t'18
                          (Efield
                            (Ederef
              ...
              (Ssequence
                (Sset _t'17
                  (Efield
                    (Ederef
                      (Etempvar _reloc_op (tptr (Tstruct _relocate_operation noattr)))
                      (Tstruct _relocate_operation noattr)) _replace_key
                    tint))
                (Sassign
                  (Efield
                    (Ederef
                            ...
                            (Ssequence
                              ...
                              (Scall (Some _t'8)
                                ...
                                ((Etempvar _t'14 (tptr (Tstruct _atom_ptr noattr))) ::
                                 ...
                                 (Etempvar _new_op (tptr (Tstruct _operation noattr))) ::
                                 nil)))
                            (Sset _clear (Etempvar _t'8 tint)))
                          (Sifthenelse (Eunop Onotbool (Etempvar _clear tint)
                                         tint)
                            (Scall None
              ...
              (Ssequence
                ...
                (Ssequence
                  (Sassign
                    (Efield
                      (Ederef
                        (Etempvar _new_op__1 (tptr (Tstruct _operation noattr)))
                        (Tstruct _operation noattr)) _op (tptr tvoid))
                    (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid)))
                  (Ssequence
                    (Ssequence
                      ...
                      (Sassign
                        ...
                        (Etempvar _t'10 tint)))
                    (Ssequence
                      (Sassign (Evar _old__1 (tptr tvoid))
                        (Etempvar _op (tptr (Tstruct _operation noattr))))
                      (Ssequence
                        (Ssequence
                          (Ssequence
                            ...
                            (Scall (Some _t'11)
                              ...
                              ((Etempvar _t'13 (tptr (Tstruct _atom_ptr noattr))) ::
                               (Eaddrof (Evar _old__1 (tptr tvoid))
                                 (tptr (tptr tvoid))) ::
                               (Etempvar _new_op__1 (tptr (Tstruct _operation noattr))) ::
                               nil)))
                          (Sset _clear__1 (Etempvar _t'11 tint)))
                        (Ssequence
                          (Sifthenelse (Eunop Onotbool
                                         (Etempvar _clear__1 tint) tint)
                            (Scall None
                              (Evar _free (Tfunction
                                            (Tcons (tptr tvoid) Tnil) tvoid
                                            cc_default))
                                  ...
                                  (Ssequence
                                    (Ssequence
                                      (Scall (Some _t'12)
                                        (Evar _surely_malloc (Tfunction
                                                               ...
                                                               (tptr tvoid)
                                                               cc_default))
                                        ((Esizeof (Tstruct _operation noattr) tuint) ::
                                         nil))
                                      (Sset _new_op__2
                                    ...
                                    (Ssequence
                                      (Sassign
                                        (Efield
                                          (Ederef
                                            (Etempvar _new_op__2 (tptr (Tstruct _operation noattr)))
                                            (Tstruct _operation noattr)) _op
                                          (tptr tvoid))
...
(Ssequence
  (Scall (Some _t'3)
    (Evar _GET_FLAG (Tfunction
                      (Tcons (tptr (Tstruct _operation noattr)) Tnil) tint
                      cc_default)) ((Etempvar _curr_op (tptr tvoid)) :: nil))
  (Sifthenelse (Ebinop Oeq (Etempvar _t'3 tint)
                 (Econst_int (Int.repr 2) tint) tint)
    (Scall None
      (Evar _helpChildCAS (Tfunction
                            (Tcons (tptr (Tstruct _operation noattr))
                              (Tcons (tptr (Tstruct _tree noattr))
                                (Tcons tint Tnil))) tvoid cc_default))
      ((Ecast (Etempvar _curr_op (tptr tvoid))
         (tptr (Tstruct _operation noattr))) ::
       (Etempvar _curr (tptr (Tstruct _tree noattr))) ::
       (Etempvar _thread_num tint) :: nil))
    (Ssequence
      (Scall (Some _t'2)
        (Evar _GET_FLAG (Tfunction
                          (Tcons (tptr (Tstruct _operation noattr)) Tnil)
                          tint cc_default))
...
Definition f_find := {|
  ...
  fn_temps := ((_result, tint) :: (_curr_key, tint) ::
               ...
               (_t'23, (tptr tvoid)) :: (_t'22, (tptr tvoid)) ::
               (_t'21, (tptr (Tstruct _atom_ptr noattr))) ::
              ...
              (Scall (Some _t'1)
                (Evar _atomic_load_ptr (Tfunction
                                         (Tcons
                                           (tptr (Tstruct _atom_ptr noattr))
                                           Tnil) (tptr tvoid) cc_default))
                ((Etempvar _t'25 (tptr (Tstruct _atom_ptr noattr))) :: nil)))
                      ...
                      (Ssequence
                        (Scall (Some _t'4)
                          ...
                          ((Etempvar _next (tptr (Tstruct _atom_ptr noattr))) ::
                           nil))
                        (Sset _tp_next (Etempvar _t'4 (tptr tvoid))))
                      (Ssequence
                        (Sloop
                          (Ssequence
                            (Ssequence
...
Definition f_add := {|
  ...
  fn_temps := ((_newNode, (tptr (Tstruct _tree noattr))) ::
               ...
               (_op, (tptr (Tstruct _operation noattr))) ::
               (_a_op, (tptr (Tstruct _atom_ptr noattr))) ::
               (_is_left, tint) :: (_old, (tptr (Tstruct _tree noattr))) ::
               (_new_op, (tptr (Tstruct _operation noattr))) ::
               (_t'16, tint) :: (_t'15, (tptr tvoid)) ::
               (_t'14, (tptr tvoid)) ::
               ...
               (_t'10, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'9, (tptr tvoid)) ::
               (_t'8, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'7, (tptr tvoid)) ::
               (_t'6, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'5, (tptr tvoid)) :: (_t'4, (tptr tvoid)) ::
               (_t'3, (tptr tvoid)) :: (_t'2, (tptr tvoid)) ::
               (_t'1, tint) :: (_t'21, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'20, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'19, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'18, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'17, (tptr (Tstruct _atom_ptr noattr))) :: nil);
  fn_body :=
(Sloop
  (Ssequence
    Sskip
    (Ssequence
      (Ssequence
        (Ssequence
          (Sset _t'21 (Evar _base_root (tptr (Tstruct _atom_ptr noattr))))
          (Scall (Some _t'1)
      ...
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'20 (Evar _curr (tptr (Tstruct _atom_ptr noattr))))
            (Scall (Some _t'2)
              (Evar _atomic_load_ptr (Tfunction
                                       (Tcons
                                         (tptr (Tstruct _atom_ptr noattr))
                                         Tnil) (tptr tvoid) cc_default))
              ((Etempvar _t'20 (tptr (Tstruct _atom_ptr noattr))) :: nil)))
                ...
                (Scall (Some _t'3)
                  (Evar _atomic_load_ptr (Tfunction
                                           (Tcons
                                             (tptr (Tstruct _atom_ptr noattr))
                                             Tnil) (tptr tvoid) cc_default))
                  ((Etempvar _t'19 (tptr (Tstruct _atom_ptr noattr))) :: nil)))
              (Sset _left_child (Etempvar _t'3 (tptr tvoid))))
            (Ssequence
              (Ssequence
                (Ssequence
                  (Sset _t'18
                  ...
                  (Scall (Some _t'4)
                    ...
                    ((Etempvar _t'18 (tptr (Tstruct _atom_ptr noattr))) ::
                     nil)))
                (Sset _right_child (Etempvar _t'4 (tptr tvoid))))
              (Ssequence
                (Ssequence
                  (Scall (Some _t'5)
                    (Evar _surely_malloc (Tfunction (Tcons tuint Tnil)
                                  ...
                                  (Ssequence
                                    (Sassign
                                      (Efield
                                        (Ederef
                                          (Etempvar _op (tptr (Tstruct _operation noattr)))
                                          (Tstruct _operation noattr)) _type
                                      ...
                                      (Ssequence
                                        (Scall (Some _t'12)
                                          ...
                                          ((Etempvar _op (tptr (Tstruct _operation noattr))) ::
                                           nil))
                                        (Sset _a_op
                                          (Etempvar _t'12 (tptr (Tstruct _atom_ptr noattr)))))
                                      (Ssequence
                                        (Sassign
                                          (Efield
                                            (Ederef
                                              ...
                                              (Tstruct _tree noattr)) _op
                                            (tptr (Tstruct _atom_ptr noattr)))
                                          (Etempvar _a_op (tptr (Tstruct _atom_ptr noattr))))
                                        (Ssequence
                                          (Sset _is_left
                                            (Ebinop Oeq
                                                              ...
                                                              (Ssequence
                                                                ...
                                                                (Scall (Some _t'16)
                                                                  ...
                                                                  (Tfunction
                                                                    ...
                                                                    tint
                                                                    cc_default))
                                                                  ((Etempvar _t'17 (tptr (Tstruct _atom_ptr noattr))) ::
                                                                   (Eaddrof
...
Definition f_delete := {|
  ...
  fn_temps := ((_tp, (tptr (Tstruct _tree noattr))) ::
               ...
               (_t'19, tint) :: (_t'18, tint) :: (_t'17, (tptr tvoid)) ::
               (_t'16, (tptr tvoid)) ::
               ...
               (_t'5, (tptr tvoid)) :: (_t'4, (tptr tvoid)) ::
               (_t'3, (tptr tvoid)) :: (_t'2, (tptr tvoid)) ::
               (_t'1, tint) :: (_t'42, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'41, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'40, (tptr (Tstruct _atom_ptr noattr))) ::
               (_t'39, (tptr (Tstruct _atom_ptr noattr))) ::
...
(Sloop
  (Ssequence
    ...
    (Ssequence
      (Ssequence
        (Ssequence
          (Sset _t'42 (Evar _base_root (tptr (Tstruct _atom_ptr noattr))))
          (Scall (Some _t'1)
            (Evar _find (Tfunction
                          (Tcons tint
                            (Tcons (tptr (tptr (Tstruct _atom_ptr noattr)))
            ...
            ((Etempvar _key tint) ::
             ...
             (Eaddrof (Evar _curr (tptr (Tstruct _atom_ptr noattr)))
               (tptr (tptr (Tstruct _atom_ptr noattr)))) ::
             (Eaddrof (Evar _curr_op (tptr tvoid)) (tptr (tptr tvoid))) ::
             (Etempvar _t'42 (tptr (Tstruct _atom_ptr noattr))) ::
             (Etempvar _thread_num tint) ::
             (Eaddrof (Evar _v (tptr tvoid)) (tptr (tptr tvoid))) :: nil)))
      ...
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'41 (Evar _curr (tptr (Tstruct _atom_ptr noattr))))
            (Scall (Some _t'2)
              (Evar _atomic_load_ptr (Tfunction
                                       (Tcons
                                         (tptr (Tstruct _atom_ptr noattr))
                ...
                (Scall (Some _t'4)
                  (Evar _atomic_load_ptr (Tfunction
                                           (Tcons
                                             (tptr (Tstruct _atom_ptr noattr))
                                             Tnil) (tptr tvoid) cc_default))
                  ((Etempvar _t'39 (tptr (Tstruct _atom_ptr noattr))) :: nil)))
...
Definition f_main := {|
  ...
  fn_vars := ((_args, (tarray (Tstruct _arg_struct noattr) 15)) ::
              ...
              (_pred_op, (tptr tvoid)) :: (_curr_op, (tptr tvoid)) ::
              (_v, (tptr tvoid)) :: nil);
  fn_temps := ((_root, (tptr (Tstruct _tree noattr))) ::
               (_val, (tptr (Tstruct _atom_ptr noattr))) ::
               (_left, (tptr (Tstruct _atom_ptr noattr))) ::
               (_right, (tptr (Tstruct _atom_ptr noattr))) ::
               (_root_op, (tptr (Tstruct _operation noattr))) ::
               (_op, (tptr (Tstruct _atom_ptr noattr))) :: (_i, tint) ::
               (_i__1, tint) :: (_i__2, tint) :: (_i__3, tint) ::
               (_l, (tptr (tarray (tptr tvoid) 2))) :: (_i__4, tint) ::
            ...
            (Ssequence
              (Scall (Some _t'3)
                (Evar _make_atomic_ptr (Tfunction (Tcons (tptr tvoid) Tnil)
                                         ...
                                         cc_default))
                ((Econst_int (Int.repr 0) tint) :: nil))
              (Sset _val (Etempvar _t'3 (tptr (Tstruct _atom_ptr noattr)))))
            (Ssequence
              (Sassign
                (Efield
                  (Ederef (Etempvar _root (tptr (Tstruct _tree noattr)))
                      ...
                      (Ssequence
                        ...
                        (Ssequence
                          (Sassign
                            (Efield
                              (Ederef
                                (Etempvar _root_op (tptr (Tstruct _operation noattr)))
                                (Tstruct _operation noattr)) _op
                              (tptr tvoid))
                            (Ecast (Econst_int (Int.repr 0) tint)
                              (tptr tvoid)))
...
(Composite __opaque_pthread_cond_t Struct
 ...
 Composite _relocate_operation Struct
   ...
   noattr ::
 Composite _operation Struct
   ((_op, (tptr tvoid)) :: (_type, tint) :: nil)
   noattr ::
