...
Global Instance flowint_elem_of : ElemOf Node flowintR :=
  λ n I, n ∈ domm I.
...
Definition intComposable (I1: flowintR) (I2: flowintR) :=
  ✓ I1 ∧ ✓ I2 ∧
  domm I1 ## domm I2 ∧
  map_Forall (λ (n: Node) (m: flowdom), m = out I2 n + (inf I1 n - out I2 n)) (infR I1) ∧
  map_Forall (λ (n: Node) (m: flowdom), m = out I1 n + (inf I2 n - out I1 n)) (infR I2).
...
(** Assorted auxiliary lemmas. These are used, in particular, to prove that flow interfaces form a ghost. *)
