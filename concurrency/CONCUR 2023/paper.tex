...
\than{What do we need to say here? (1) - still keep subsection and filled \texttt{insertOp} and the way we prove \texttt{insert} here, or (2) - get rid of this subsection.}
\subsection{Give-up BST}
\label{BST_giveup_insert}
\than{What do we need to say here? (1) - still keep subsection and filled \texttt{insertOp}, and \texttt{inRange} and the way we prove \texttt{insert} here, or (2) - get rid of this subsection.}
