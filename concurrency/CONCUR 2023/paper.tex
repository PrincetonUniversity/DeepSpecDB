...
%The loop invariants mentioned above include specific existential variables (such as $\mathsf{n'}$) that define the state of each iteration throughout the loop.
