...
\begin{figure}[!ht]
	\begin{subfigure}[t]{0.48\textwidth}
		...
		\caption{The \lstinline{traverse} method of the give-up template algorithm}
	\end{subfigure}\qquad
	\begin{subfigure}[t]{0.48\textwidth}
	...
	\end{subfigure}
	\caption{The \lstinline{traverse} method of the give-up and lock-coupling template algorithms}
	\label{traverse}
\end{figure}
