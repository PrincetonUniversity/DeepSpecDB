...
The specification of \lstinline{inRange} is:
	\begin{mathpar}
		% inRange for give-up
		{\color{blue}
			\left\{ 
	...
	\end{mathpar}
It simply computes whether the input key \lstinline{k} is in the range \texttt{(min, max)} associated with the node \texttt{n}, and returns 0 or 1 accordingly.
