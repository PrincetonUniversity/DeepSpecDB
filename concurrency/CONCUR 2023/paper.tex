...
Given this invariant, the proof proceeds as follows. %\wm{Should we consider giving annotated code after all?} 
...
\section{Proofs for Section \ref{} and \ref{label}}
\label{sec:apd_proof}
Below are partially completed proofs of \texttt{traverse} for the give-up template (Figure \ref{proof_giveup_traverse}), as well as proofs of \texttt{insert} for the lock-coupling and give-up templates, annotated with separation logic specifications. The complete proofs can be found in our Coq mechanization, which is mentioned in Section \ref{proof_mech} for reference.
