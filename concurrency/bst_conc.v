...
Definition _pushdown_left : ident := 97%positive.
...
Definition _tgl : ident := 88%positive.
Definition _tgp : ident := 70%positive.
Definition _tgq : ident := 94%positive.
Definition _tgr : ident := 89%positive.
