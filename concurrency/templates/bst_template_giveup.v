...
Module Info.
  ...
  Definition source_file := "bst_template_giveup.c".
...
Definition _lp : ident := $"lp".
Definition _lq : ident := $"lq".
...
Definition _tgl : ident := $"tgl".
Definition _tgp : ident := $"tgp".
Definition _tgq : ident := $"tgq".
Definition _tgr : ident := $"tgr".
          ...
          (Ssequence
            ...
            (Ssequence
              (Sassign
                (Efield
                  (Ederef (Etempvar _newt (tptr (Tstruct _tree_t noattr)))
                    (Tstruct _tree_t noattr)) _min tint)
                (Ebinop Osub
              ...
              (Ssequence
                (Sassign
                  (Efield
                    (Ederef (Etempvar _newt (tptr (Tstruct _tree_t noattr)))
                      (Tstruct _tree_t noattr)) _max tint)
...
Definition f_inrange := {|
  ...
  fn_temps := ((_t'1, tint) :: (_t'5, tint) ::
               (_t'4, (tptr (Tstruct _tree_t noattr))) :: (_t'3, tint) ::
      ...
      (Sset _t'3
        (Efield
          (Ederef (Etempvar _t'2 (tptr (Tstruct _tree_t noattr)))
            (Tstruct _tree_t noattr)) _min tint))
      (Sifthenelse (Ebinop Ogt (Etempvar _x tint) (Etempvar _t'3 tint) tint)
        (Ssequence
          (Sset _t'4
            (Efield
              (Ederef (Etempvar _pn__2 (tptr (Tstruct _pn noattr)))
          ...
          (Ssequence
            ...
            (Sset _t'1
              (Ecast
                (Ebinop Olt (Etempvar _x tint) (Etempvar _t'5 tint) tint)
                tbool))))
...
Definition f_traverse := {|
  ...
  fn_params := ((_pn__2, (tptr (Tstruct _pn noattr))) :: (_x, tint) ::
                (_value, (tptr tvoid)) :: nil);
  fn_vars := nil;
  fn_temps := ((_p, (tptr (Tstruct _tree_t noattr))) :: (_flag, tint) ::
               (_b, tint) :: (_t'2, tint) :: (_t'1, tint) ::
          ...
          (Ssequence
            (Ssequence
              ...
              (Ssequence
                (Sset _t'11
                  (Efield
                    (Ederef (Etempvar _t'10 (tptr (Tstruct _tree_t noattr)))
                      (Tstruct _tree_t noattr)) _lock
                    (tptr (Tstruct _atom_int noattr))))
                (Scall None
                  (Evar _acquire (Tfunction
                                   (Tcons (tptr (Tstruct _atom_int noattr))
                                     Tnil) tvoid cc_default))
                  ((Etempvar _t'11 (tptr (Tstruct _atom_int noattr))) :: nil))))
            (Ssequence
              (Ssequence
                (Sset _t'9
                  (Efield
                  ...
                  (Ssequence
                    ...
                    (Ssequence
                      (Sset _t'6
                        (Efield
                          (Ederef
                            (Etempvar _t'5 (tptr (Tstruct _tree_t noattr)))
                            ...
                            (Ssequence
                              ...
                              (Ssequence
                                (Sset _t'8
                                  (Efield
                                    (Ederef
                                      (Etempvar _t'7 (tptr (Tstruct _tree_t noattr)))
                                      (Tstruct _tree_t noattr)) _lock
                                    (tptr (Tstruct _atom_int noattr))))
                                (Scall None
                                  (Evar _release (Tfunction
...
Definition f_insertOp := {|
  ...
  fn_temps := ((_p1, (tptr (Tstruct _tree_t noattr))) ::
               ...
               (_t'18, (tptr (Tstruct _tree_t noattr))) ::
               (_t'17, (tptr (Tstruct _tree noattr))) ::
               (_t'16, (tptr (Tstruct _tree_t noattr))) ::
               ...
               (_t'10, (tptr (Tstruct _tree_t noattr))) :: (_t'9, tint) ::
               (_t'8, (tptr (Tstruct _tree_t noattr))) :: (_t'7, tint) ::
                      ...
                      (Ssequence
                        ...
                        (Ssequence
                          ...
                          (Sassign
                            (Efield
                              (Ederef
                                (Etempvar _t'18 (tptr (Tstruct _tree_t noattr)))
                                (Tstruct _tree_t noattr)) _t
                              (tptr (Tstruct _tree noattr)))
                        ...
                        (Ssequence
                          ...
                          (Ssequence
                            (Sset _t'17
                              (Efield
                                (Ederef
                                  (Etempvar _t'16 (tptr (Tstruct _tree_t noattr)))
                                  (Tstruct _tree_t noattr)) _t
                                (tptr (Tstruct _tree noattr))))
                            (Sassign
                              (Efield
        ...
        (Sassign
          (Efield
            (Ederef (Etempvar _l (tptr (Tstruct _tree noattr)))
              (Tstruct _tree noattr)) _right (tptr (Tstruct _tree_t noattr)))
    ...
    (Ssequence
      (Ssequence
        ...
        (Ssequence
          (Sset _t'7
            (Efield
              (Ederef (Etempvar _t'6 (tptr (Tstruct _tree_t noattr)))
                (Tstruct _tree_t noattr)) _lock
              (tptr (Tstruct _atom_int noattr))))
          (Scall None
            (Evar _acquire (Tfunction
                             (Tcons (tptr (Tstruct _atom_int noattr)) Tnil)
                             tvoid cc_default))
            ((Etempvar _t'7 (tptr (Tstruct _atom_int noattr))) :: nil))))
      (Ssequence
        (Ssequence
          (Scall (Some _t'2)
            (Evar _traverse (Tfunction
            ...
            (Ssequence
              ...
              (Scall None
                (Evar _pushdown_left (Tfunction
                                       (Tcons (tptr (Tstruct _tree_t noattr))
                                         Tnil) tvoid cc_default))
                ((Etempvar _t'5 (tptr (Tstruct _tree_t noattr))) :: nil)))
            (Ssequence
              (Sset _t'3
                (Efield
                  (Ederef (Etempvar _pn__2 (tptr (Tstruct _pn noattr)))
...
Definition f_main := {|
  ...
  fn_temps := ((_t_lock, (tptr (Tstruct _atom_int noattr))) ::
               ...
               (_t'15, (tptr (tptr (Tstruct _tree_t noattr)))) ::
               (_t'14, (tptr (tptr (Tstruct _tree_t noattr)))) ::
               (_t'13, (tptr (tptr (Tstruct _tree_t noattr)))) ::
               (_t'12, (tptr (tptr (Tstruct _tree_t noattr)))) ::
               (_t'11, (tptr (tptr (Tstruct _tree_t noattr)))) ::
               (_t'10, (tptr (tptr (Tstruct _tree_t noattr)))) ::
...
(Ssequence
  (Ssequence
    ...
    (Ssequence
      (Ssequence
        (Sset _t'15 (Evar _tb (tptr (tptr (Tstruct _tree_t noattr)))))
        (Scall None
          (Evar _insert (Tfunction
                          (Tcons (tptr (tptr (Tstruct _tree_t noattr)))
                            (Tcons tint (Tcons (tptr tvoid) Tnil))) tvoid
                          cc_default))
          ((Etempvar _t'15 (tptr (tptr (Tstruct _tree_t noattr)))) ::
           (Econst_int (Int.repr 3) tint) ::
           (Evar ___stringlit_4 (tarray tschar 6)) :: nil)))
      (Ssequence
        (Ssequence
          (Sset _t'14 (Evar _tb (tptr (tptr (Tstruct _tree_t noattr)))))
          (Scall None
            (Evar _insert (Tfunction
                            (Tcons (tptr (tptr (Tstruct _tree_t noattr)))
                              (Tcons tint (Tcons (tptr tvoid) Tnil))) tvoid
                            cc_default))
            ((Etempvar _t'14 (tptr (tptr (Tstruct _tree_t noattr)))) ::
             (Econst_int (Int.repr 1) tint) ::
             (Evar ___stringlit_5 (tarray tschar 4)) :: nil)))
        (Ssequence
          (Ssequence
            (Sset _t'13 (Evar _tb (tptr (tptr (Tstruct _tree_t noattr)))))
            (Scall None
              (Evar _insert (Tfunction
                              (Tcons (tptr (tptr (Tstruct _tree_t noattr)))
                                (Tcons tint (Tcons (tptr tvoid) Tnil))) tvoid
                              cc_default))
              ((Etempvar _t'13 (tptr (tptr (Tstruct _tree_t noattr)))) ::
               (Econst_int (Int.repr 4) tint) ::
                  ...
                  (Ssequence
                    (Scall None
                      (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil)
                                      tint
                                      {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                      ((Evar ___stringlit_7 (tarray tschar 11)) :: nil))
                    (Ssequence
                      (Ssequence
                        (Sset _t'12
                        ...
                        (Scall None
                          (Evar _traverseInorder (Tfunction
                                                   (Tcons
                                                     (tptr (tptr (Tstruct _tree_t noattr)))
                                                     Tnil) tvoid cc_default))
                          ((Etempvar _t'12 (tptr (tptr (Tstruct _tree_t noattr)))) ::
                           nil)))
                      (Ssequence
                        (Ssequence
                          (Sset _t'11
                            (Evar _tb (tptr (tptr (Tstruct _tree_t noattr)))))
                          (Scall None
                            (Evar _delete (Tfunction
                                            (Tcons
                                              (tptr (tptr (Tstruct _tree_t noattr)))
                                              (Tcons tint Tnil)) tvoid
                                            cc_default))
                            ((Etempvar _t'11 (tptr (tptr (Tstruct _tree_t noattr)))) ::
                             (Econst_int (Int.repr 1) tint) :: nil)))
                        (Ssequence
                          (Ssequence
                            (Sset _t'10
                            ...
                            (Scall None
                              (Evar _delete (Tfunction
                                              (Tcons
                                                ...
                                                (Tcons tint Tnil)) tvoid
                                              cc_default))
                              ((Etempvar _t'10 (tptr (tptr (Tstruct _tree_t noattr)))) ::
                               (Econst_int (Int.repr 1) tint) :: nil)))
                          (Ssequence
                            (Ssequence
                              (Sset _t'9
                                    ...
                                    (Scall None
                                      (Evar _printf (Tfunction
                                                      (Tcons (tptr tschar)
                                                        Tnil) tint
                                                      {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                                      ((Evar ___stringlit_7 (tarray tschar 11)) ::
                                       nil))
                                    (Ssequence
                                      (Ssequence
                                        (Sset _t'5
                                      ...
                                      (Ssequence
                                        ...
                                        (Ssequence
                                          (Ssequence
                                            (Sset _t'3
                                              (Evar ___stdoutp (tptr (Tstruct ___sFILE noattr))))
                                            (Scall None
...
(_main :: _thread_func :: _traverseInorder :: _Inorder :: _delete ::
 _pushdown_left :: _turn_left :: _lookup :: _insert :: _insertOp ::
 _traverse :: _inrange :: _findnext :: _treebox_free :: _tree_free ::
 _treebox_new :: _surely_malloc :: _tb :: _spawn :: _release :: _acquire ::
 _freelock :: _makelock :: _exit :: _free :: _malloc :: _printf :: _fflush ::
 ___stdoutp :: ___builtin_debug :: ___builtin_write32_reversed ::
