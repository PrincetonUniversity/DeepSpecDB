...
Module Info.
  ...
  Definition source_file := "bst_giveup.c".
              ...
              (Ssequence
                ...
                (Ssequence
                  ...
                  (Ssequence
                    ...
                    (Ssequence
                      (Sassign
                        (Efield (Evar _dlist (Tstruct _DList noattr)) _size
                          tulong) (Econst_int (Int.repr 2) tint))
                      (Ssequence
                        (Ssequence
                          (Ssequence
                            (Sset _t'19
...
(Ssequence
  (Scall None
    ...
    ((Evar ___stringlit_1 (tarray tschar 18)) :: nil))
  (Ssequence
