...
{\begin{array}{l}
		...
		\ \ \ \ \ \  \texttt{pn} \mapsto \left(n', n'\right) \ast  \inFP\left(n'\right) \ast\ \texttt{k} \in \mathsf{range}\ \ast \ 
		\\ 
