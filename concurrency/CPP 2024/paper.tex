...
%https://tex.stackexchange.com/questions/112634/how-to-draw-a-diagram-with-boxes-of-text-inside-each-other-and-have-them-laid-ou
\newcommand\TBox[2][]{%
  \tikz\node[draw,align=left,#1] {#2};\hskip2pt}
...
\acmConference[CPP '24]{Proceedings of the 13th ACM SIGPLAN International Conference on Certified Programs and Proofs}{Jan 15--16, 2024}{London, United Kingdom}
\acmBooktitle{Proceedings of the 13th ACM SIGPLAN International Conference on Certified Programs and Proofs (CPP '24), Jan 15--16, 2024, London, United Kingdom}
...
This work was partially funded by the National Science Foundation under the award 1005849 (Veriﬁed High Performance Data Structure Implementations, Beringer \& Mansky) and the Defense Advanced Research Projects Agency (DARPA) under contract HR001120C0160.
\end{acks}
