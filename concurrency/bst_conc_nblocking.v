...
(Composite _tree Struct
   (Member_plain _key tint ::
    Member_plain _value (tptr (Tstruct _atom_ptr noattr)) ::
    Member_plain _left (tptr (Tstruct _atom_ptr noattr)) ::
    Member_plain _right (tptr (Tstruct _atom_ptr noattr)) :: nil)
   noattr :: nil).
