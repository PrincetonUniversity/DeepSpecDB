...
\begin{minted}[breaklines]{coq}
Module Trie (Node: FLATTENABLE_TABLE Keyslice)
            <: FLATTENABLE_TABLE KeyType.
  [...]
    ...
    | trienode_of _ tableform listform =>
      ...
      | Some (_, bnode) =>
        if (Z_le_dec (Zlength k) keyslice_length) then
          [(t, Node.make_cursor keyslice tableform,
          ...
          | None =>
            ...
            | value_of _ => []
            | nil => [(t, Node.make_cursor keyslice tableform,
    ...
    | trienode_of _ tableform listform =>
      ...
      | Some (_, bnode) =>
        ...
        | BorderNode.before_prefix len =>
          ...
          | value_of _ =>
            Some [(t, Node.first_cursor tableform,
        ...
        | BorderNode.before_suffix =>
          ...
          | trie_of t' =>
            ...
            | Some c' => Some ((t, Node.first_cursor tableform,
  ...
  Definition first_cursor (c: cursor) (t: table): cursor :=
